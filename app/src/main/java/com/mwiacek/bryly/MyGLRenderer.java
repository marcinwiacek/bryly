    ...
    public void ChangeFigura() {
        ...
        if (spinner3.getSelectedItemPosition() == 0) {
            switch (spinner1.getSelectedItemPosition()) {
                case 0: //graniastosłup prawidłowy
                case 1: //graniastosłup pochyły
                    ...
                    for (i = 0; i < ilosc; i++) {
                        ...
                        vertices[i * 18] = 0.3f * ((Number) Math.sin(2 * Math.PI / ilosc * (i + 1))).floatValue();
                ...
                case 3: //ostroslup pochyly
                    ...
                    if (!checkbox1.isChecked()) {
                        ...
                        for (i = 0; i < ilosc; i++) {
                            //linia podstawy
                            vertices[i * 12] = 0.4f * ((Number) Math.sin(2 * Math.PI / ilosc * i)).floatValue();
                        ...
                        for (i = 0; i < ilosc; i++) {
                            //linia podstawy
                            vertices[i * 18] = 0.4f * ((Number) Math.sin(2 * Math.PI / ilosc * i)).floatValue();
                ...
                case 4: //prostopadłościan
                    ...
                    //linia dolnej podstawy
                    vertices[i * 18] = 0.3f * ((Number) Math.sin(start)).floatValue();
                ...
                case 6: //stozek pochyly
                    ...
                    if (!checkbox1.isChecked()) {
                        ...
                        for (i = 0; i < 720; i++) {
                            //linia podstawy
                            vertices[i * 6] = 0.4f * ((Number) Math.sin(i * 2 * Math.PI / 360)).floatValue();
                        ...
                        for (i = 720; i < 720 + 20; i++) {
                            //linia boczna od dolu do g�ry
                            vertices[i * 6] = 0.4f * ((Number) Math.sin(2 * Math.PI / 20 * i)).floatValue();
                        ...
                        for (i = 720 + 20; i < 720 + 720 + 20; i++) {
                            //linia gornej podstawy
                            vertices[i * 6] = 0.4f * 0.4f * ((Number) Math.sin((i) * 2 * Math.PI / 360)).floatValue() + GoraX * 0.6f;
                ...
                case 9: //walec pochyly
                    ...
                    for (i = 0; i < 720; i++) {
                        //linia podstawy
                        vertices[i * 12] = 0.4f * ((Number) Math.sin(i * 2 * Math.PI / 360)).floatValue();
        ...
        switch (spinner1.getSelectedItemPosition()) {
            ...
            case 1: //graniastosłup pochyły
                ...
                break;
            case 2: //ostrosłup prawidłowy
            case 3: //ostrosłup pochyły
            case 5: //stozek prosty
            case 6: //stozek pochyly
                promien = 0.4f;
                if (spinner1.getSelectedItemPosition() > 3) {
